...
function longGcdBin(a, b) {
  ...
  while (a.isNonZero()) {
    ...
    if (longAbsCmp(a, b) > -1) {
      a = longHalf(longSub(a, b));
    } else {
      b = longHalf(longSub(a, b));
    }
  }
...
Long.prototype = {
   ...
   * @see longGcdBin
   */
  _gcd: function(a) { return longGcdBin(this, a); },
   ...
   * @see longCmp
   */
  cmp: function(a) { return longCmp(this, longint(a)); },
   ...
   * @see longEq
   */
  eq: function(a) { return longEq(this, a); },
   ...
   * @see longEqual
   */
  equal: function(a) { return longEqual(this, a); },
   ...
   * @see longAbs
   */
  abs: function() { return longAbs(this); },
   ...
   * @see longNeg
   */
  neg: function() { return longNeg(this); }
};

// static method
Long.longint = longint;
Long.num = longNum;
Long.str = longStr;
