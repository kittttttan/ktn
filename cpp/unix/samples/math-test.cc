#include "math-test.h"
#include <ktn/math/complex.h>
#include <ktn/math/vector.h>
#include <ktn/math/matrix.h>
...
void ulongBasic()
{
    ...
    puts("** Test for ULong **");
	printf("0 = "); ULong::ZERO.out();
	printf("1 = "); ULong::ONE.out();
	printf("a = "); a.out();
...
void longBasic()
{
    ...
    puts("** Test for Long **");
	printf("0 = "); Long::ZERO.out();
	printf("1 = "); Long::ONE.out();
	printf("a = "); a.out();
    printf("b = "); b.out();
    printf("!a = %s\n", !a ? "true" : "false");
    printf("-a = "); (-a).out();
